...
void ContactManager::Add(const b2ContactPoint* point)
{
...
void ContactManager::Persist(const b2ContactPoint* point)
{
    if (m_contactCount == k_maxContactPoints)
    {
        return;
...
void ContactManager::Remove(const b2ContactPoint* point)
{
}


void ContactManager::Result(const b2ContactResult* point)
{
}
