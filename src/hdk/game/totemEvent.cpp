...
totemEvent::totemEvent() : hdPolygon()
{
    m_userType = (int)e_totemTypeEvent;
    m_firstObject = NULL;
    m_secondObject = NULL;
}


totemEvent::totemEvent(hdGameWorld *gameWorld,
...
void totemEvent::Init(hdGameWorld *gameWorld)
{
...
const int totemEvent::SetFirstObject(const hdGameObject* body)
{
...
const int totemEvent::SetSecondObject(const hdGameObject* body)
{
...
bool totemEvent::AABBIntersection(const hdAABB& aabb)
{
    hdAABB depthAABB;
