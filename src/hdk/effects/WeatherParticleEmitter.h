...
#ifndef _HDK_WEATHER_PARTICLE_EMITTER_H
...
class WeatherParticleEmitter : public hdParticleEmitter
{
public:
    WeatherParticleEmitter(int maxParticles,
                                const char * texture,
                                ...
                                const hdVec3& directionLo, const hdVec3& directionHi);

    ~WeatherParticleEmitter();
...
private:
    ...
    hdGameObject *m_boundingBoxProvider;
    
    hdVec3 m_directionLo, m_directionHi;
