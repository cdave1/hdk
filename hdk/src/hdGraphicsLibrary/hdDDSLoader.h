...
#ifndef _HD_DDS_LOADER_
#define _HD_DDS_LOADER_
...
extern bool LoadDDS( const char *filename, unsigned char **pic, unsigned short *width, unsigned short *height, unsigned short *bytes );
