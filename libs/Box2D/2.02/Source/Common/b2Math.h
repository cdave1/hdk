...
{
#ifdef B2_OPTIMIZED_FUNCTIONS_H
	float res[2];
	opt_b2Vec2Mul(&(A.col1.x), &(v.x), res);
	return b2Vec2(res[0], res[1]);
#else
...
#ifdef B2_OPTIMIZED_FUNCTIONS_H
	float res[4];
	opt_b2MatMul(&(A.col1.x), &(B.col1.x), res);
	return b2Mat22(res[0], res[1], res[2], res[3]);
#else
...
//#ifdef B2_OPTIMIZED_FUNCTIONS_H
//	float res[4];
//	opt_b2MatMulT(&(A.col1.x), &(B.col1.x), res);
//	return b2Mat22(res[0], res[1], res[2], res[3]);
//#else
...
#ifdef B2_OPTIMIZED_FUNCTIONS_H
	float res[3];
	opt_b2Vec3Mul(&(A.col1.x), &(v.x), res);
	return b2Vec3(res[0], res[1], res[2]);
#else
