...
//const float32 b2_linearSlop = 0.05f;	// 0.5 cm
...
//const float32 b2_maxLinearCorrection = 0.1f;	// 20 cm
...
//const float32 b2_contactBaumgarte = 0.5f;

// Sleep

/// The time that a body must be still before it will go to sleep.
//const float32 b2_timeToSleep = 0.5f;									// half a second
const float32 b2_timeToSleep = 0.25f;									// half a second

/// A body cannot sleep if its linear velocity is above this tolerance.
const float32 b2_linearSleepTolerance = 0.01f;		// 1 cm/s
//const float32 b2_linearSleepTolerance = 0.05f;		// 1 cm/s
